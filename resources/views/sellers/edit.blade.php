...
<head>
    ...
    <title>Verkoper Bewerken - Verkopers Beheer</title>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('sellers.update', $seller) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               name="special_status" 
                                               value="1"
                                               {{ old('special_status', $seller->special_status) ? 'checked' : '' }}>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">Verkoper Bijwerken</button>
